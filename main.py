...
# =========================================================
# Daily market read (your frontend uses /market/read)
# =========================================================
@app.get("/market/read")
def market_read():
...
def news_briefing(
    ...
    out = {
        ...
        "sectors": sectors_out,
        "errors": errors,
        "note": f"Google News RSS. Headlines limited to last {max_age_days} days. Per-headline summaries are extracted from publisher pages when possible.",
    }
